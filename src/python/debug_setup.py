...
try:
    ...
    if key:
        ...
        # ✅ FIX: Use a stable model name (gemini-1.5-flash)
        # 'gemini-flash-latest' sometimes resolves poorly in older SDK versions
...
try:
    ...
    try:
        ...
        print(f"⚠️ MediaPipe installed but failed to initialize: {e}")
