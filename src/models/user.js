...
const userSchema = new mongoose.Schema(
  {
    ...
    // ✅ CRITICAL: Dashboard looks for these specific fields
    skillGaps: { type: [String], default: [] },
    learningRoadmap: { type: [Object], default: [] }, // Matches controller

    // Keep legacy field just in case, but 'learningRoadmap' is the primary now
    roadmap: { type: Object, default: {} },
  },
  { timestamps: true }
);
